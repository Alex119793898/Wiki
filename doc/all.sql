...
create table `ebook` (
    ...
    `descriptionn` varchar(200) comment '描述',
...
insert into `ebook` (id,name,descriptionn) values (1,'Spring Boot 入门教程','0基础入门 Java 开发，企业级应用开发最佳首选框架');
insert into `ebook` (id,name,descriptionn) values (2,'Vue 入门教程','0基础入门 Vue 开发，企业级应用开发最佳首选框架');
insert into `ebook` (id,name,descriptionn) values (3,'Python 入门教程','0基础入门 Python 开发，企业级应用开发最佳首选框架');
insert into `ebook` (id,name,descriptionn) values (4,'MySql 入门教程','0基础入门 MySql 开发，企业级应用开发最佳首选框架');
insert into `ebook` (id,name,descriptionn) values (5,'Oracle 入门教程','0基础入门 Oracle 开发，企业级应用开发最佳首选框架');
...
insert into doc (id,ebook_id,parent,name,sort,view_count,vote_count) values (7,1,5,'文档2.2.2',2,0,0);
insert into doc (id,ebook_id,parent,name,sort,view_count,vote_count) values (8,1,0,'文档3',3,0,0);
